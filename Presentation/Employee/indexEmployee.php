...
<body>
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select tabindex="1" data-placeholder="typeDocument" class="span4">
                                                <option value="">Tipo de documento</option>
                                                <option value="C.C.">C.C.</option>
                                                <option value="C.E.">C.E.</option>
                                            </select>
                                            <input type="text" id="basicinput" placeholder="Número de documento"
                                                class="span5">
                                        </div>
                                    </div>
    ...
    <script src="<?php echo ROOT_DIRECTORY . ROUTE_ASSETS . 'scripts/datatables/jquery.dataTables.js' ?>"
        type="text/javascript"></script>
    <script src="<?php echo ROOT_DIRECTORY . ROUTE_ASSETS . 'scripts/common.js' ?>" type="text/javascript">
    </script>
