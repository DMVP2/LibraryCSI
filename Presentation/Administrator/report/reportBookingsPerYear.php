...
$bookingyDriving = new BookingDriving($connection);


$year = $_GET['year'];
$dataPoints = $bookingyDriving->getReportBookingsPerYear($year);

$title = "Reservas realizadas mes a mes en el año " . $_GET['year'];
...
$(document).ready(function() {
    ...
    $("#year").change(function() {
        ...
        route =
            <?php echo "'" . ROOT_DIRECTORY . ROUTE_ADMINISTRATOR . "report/reportBookingsPerYear.php" . "'" ?>;
