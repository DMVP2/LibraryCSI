...
$year = $_GET['year'];
$dataPoints = $documentDriving->getDownloadsPerYear($year);

$title = "Descargas realizadas mes a mes en el año " . $_GET['year'];
...
$(document).ready(function() {
    ...
    $("#year").change(function() {
        ...
        route =
            <?php echo "'" . ROOT_DIRECTORY . ROUTE_ADMINISTRATOR . "report/reportDownloadPerYear.php" . "'" ?>;
