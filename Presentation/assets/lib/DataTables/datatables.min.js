...
(function(k) {
	...
	function ma(a) {
		...
		if (a) {
			...
			!a.sEmptyTable && d && "No hay datos disponibles" === b.sEmptyTable && V(a, a, "sZeroRecords", "sEmptyTable");
	...
	function Ib(a) {
		...
		var l = k("<div><label style='padding-left:1.1em;'/></div>").addClass(b.sLength);
