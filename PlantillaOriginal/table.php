                ...
                <div class="span3">
                    <div class="sidebar">
                        ...
                        <ul class="widget widget-menu unstyled">
                            ...
                            <li><a href="table.html"><i class="menu-icon icon-table"></i>Tables a </a></li>
                            ...
                            <li>
                                <a class="collapsed" data-toggle="collapse" href="#togglePages">
                                    ...
                                    <i class="icon-chevron-down pull-right"></i><i
                                        class="icon-chevron-up pull-right"></i>
                                    More Pages
                                </a>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Tables a<i class="fa fa-chevron-right shaded"></i></h3>
                            </div>
