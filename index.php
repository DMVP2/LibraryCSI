        ...
        success: function(response) {
            ...
            if (jsonData.success == "1") {
                window.location.href =
                    "<?php echo ROOT_DIRECTORY . ROUTE_CLIENT . 'MyBookings.php?cod=1'  ?>"; //enviar a reserva
            } else {
...
function renovateBooking(pIdDocument, pDiasRenovacion) {
    $.ajax({
        ...
        success: function(response) {
            ...
            if (jsonData.success == "1") {
                window.location.href =
                    "<?php echo ROOT_DIRECTORY . ROUTE_CLIENT . 'MyBookings.php?cod=2'  ?>"; //enviar a reserva
            } else {
                notifications.showNotificationWarning("Ha ocurrido un error");
            }
        }
...
function payPenaltyBooking(pIdDocument) {
    $.ajax({
        ...
        success: function(response) {
            ...
            if (jsonData.success == "1") {
                window.location.href =
                    "<?php echo ROOT_DIRECTORY . ROUTE_CLIENT . 'MyBookings.php?cod=3'  ?>"; //enviar a reserva
            } else {
                notifications.showNotificationWarning("Ha ocurrido un error");
            }
        }
...
function joinQueue(pIdDocument) {
    $.ajax({
        ...
        success: function(response) {
            ...
            if (jsonData.success == "1") {
                window.location.href =
                    "<?php echo ROOT_DIRECTORY . ROUTE_CLIENT . 'MyBookings.php?cod=4' ?>"; //enviar a reserva
            } else {
                notifications.showNotificationWarning("Ha ocurrido un error");
            }
        }
